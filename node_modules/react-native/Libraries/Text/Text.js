  ...
  render(): React.Element<any> {
	...
	try{ 
		if (Platform.OS === 'android') {
			if (typeof(newProps.style) === 'undefined') {
				newProps = {
					...newProps,
					style: {includeFontPadding: false},
				};
			}
			else if (typeof(newProps.style) === 'number') {
				let defaultStype = StyleSheet.flatten(newProps.style);
				if(typeof(defaultStype.includeFontPadding) === 'undefined') {
					newProps = {
						...newProps,
				...
				if(typeof(newProps.style.includeFontPadding) === 'undefined') {
					newProps = {
						...newProps,
						style: [this.props.style, {includeFontPadding: false}],
					};
